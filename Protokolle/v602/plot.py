...
plt.axvline(x=18.6, linestyle='--', linewidth = 1.5, color = 'seagreen', label = r"$\theta_{K} = \qty{18,60}{\degree}$")
...
plt.axvline(x=13.18, linestyle='--', linewidth = 1.5, color = 'seagreen', label = r"$\theta_{K} = \qty{13,18}{\degree}$")
...
plt.axvline(x=17.32, linestyle='--', linewidth = 1.5, color = 'seagreen', label = r"$\theta_{K} = \qty{17,32}{\degree}$")
...
plt.axvline(x=11.02, linestyle='--', linewidth = 1.5, color = 'seagreen', label = r"$\theta_{K} = \qty{11.02}{\degree}$")
...
plt.axhline(y=(oben+unten)/2, linestyle='--', linewidth = 1.5, color = 'forestgreen', label = r'Mittelwert')
plt.axvline(x=9.90, linestyle='--', linewidth = 1.5, color = 'seagreen', label = r"$\theta_{K} = \qty{9,90}{\degree}$")
...
plt.ylabel(r'$\sqrt{E_K}\mathbin{/}\sqrt{\symup{eV}} $')
#plt.xlim(26, 36)
#plt.ylim(95, 135)
plt.legend()
